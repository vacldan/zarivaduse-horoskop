...
if submit:
    ...
    if not dt:
        st.error("Chyba formátování času.")
        st.stop()
    params = {"datetime": dt, "coordinates": f"{poz['latitude']},{poz['longitude']}",
              "ayanamsa": 1, "house_system": "placidus", "orb": "default", "timezone": poz['timezone']}
    all_data = {}
